  ...
  const portfolioLinks = [
    {
      ...
      caption:
        "Located on Mount Desert Island, Acadia National Park is the Pine Tree State’s natural jewel. The park has three campgrounds to set up your tent: Blackwoods (close to Bar Harbor), Seawall (less touristy), and Schoodic Woods (on the Schoodic Peninsula)",
    },
    {
      title: "White Mountain National Forest, New Hampshire and Maine",
      caption:
        "If you're looking for a rugged hike, look no further than this northernmost part of the Appalachian Valley. The sights are particularly magical in the fall when leaf-peeping season is at its peak. Plus, the forest has several campgrounds with a combined hundreds of campsites.",
    },
    {
    ...
    },
    {
      ...
      caption:
        "You can have one of the world's largest barrier reefs right outside your tent in this beautiful park. Campers can rent some snorkel gear and spend their days on the beach or explore Fort Jefferson. This area is also great for bird-watching, so make sure you pack a pair of binoculars. ",
    },
    {
    ...
    },
    {
      ...
      caption:
        "The steep Smoky Mountains offer stunning views, practically like a Bob Ross painting. There are dozens of campgrounds at this national forest, but one of the best spots is Sawtooth National Recreation Area. ",
    },
    {
        ...
        <div className="container">
          <div className="intro-text">
            ...
            <div className="intro-heading text-uppercase">
              Find reservations at sold-out campgrounds
            </div>
            <a
          ...
          <div className="row">
            <div className="col-lg-12 text-center">
              ...
              <h3 className="section-subheading text-muted">
                Tell us when, where, and how long you want to camp for. We’ll
                notify you (via SMS) when a suitable spot opens up at that
                campground—so you can nab that sold-out campsite reservation!
                Plans start at $10
              </h3>
            </div>
          </div>
                ...
                <li className="timeline-inverted">
                  ...
                  <div className="timeline-panel">
                    <div className="timeline-heading">
                      <h4>July 2023</h4>
                      <h4 className="subheading">
                        Phase of Deployment and Full Service
                      </h4>
                    </div>
                    <div className="timeline-body">
                      <p className="text-muted">
